...
def encrypt(pubkey, chunk):
    ...
    # c = (chunk ** pubkey.e) % pubkey.n
    c = pow(chunk, pubkey.e, pubkey.n)
    return c


def decrypt(privkey, chunk):
    # TODO: implement decryption
    # m = (chunk ** privkey.d) % privkey.n
    m = pow(chunk, privkey.d, privkey.n)
    return m
